...
class ProductViewModel {
    ...
    func getCategory() {
        ApiManagerAF.shared.callAPI(urlString: ApiManagerAF.storeUrl+"products/categories", method: .get) { [weak self]
    ...
    func getAllProduct() {
        ApiManagerAF.shared.callAPI(urlString: ApiManagerAF.storeUrl+"products", method: .get) { [weak self]
