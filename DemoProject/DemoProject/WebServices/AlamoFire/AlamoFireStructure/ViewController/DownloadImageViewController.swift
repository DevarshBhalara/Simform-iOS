...
class DownloadImageViewController: UIViewController {
    ...
    @IBOutlet private weak var progressDownload: UIProgressView!
    @IBOutlet private weak var lblProgress: UILabel!
    @IBOutlet private weak var lblDownload: UILabel!
    @IBOutlet private weak var tfDownloadUrl: UITextField!
    @IBOutlet private weak var lblLocation: UILabel!
    
    //MARK: Variable
    private let viewModel = DownloadImageViewModel()
